...
public class TreePruner
{
	 ...
	 */
	public TreePruner(DataSet dataSet, AttributeDelegate[] attributeDelegates, 
			...
			boolean update)
	{
		...
		int testAttributeIndex = indexOf(internalNode
				.getTestAttribute().getName(), this.dataSet.getAttributeNames());
		...
		TreeNode parent = (InternalNode) internalNode.getParent();
			...
			if (estimatedBranchError <= estimatedTreeError + 0.1)
		{
